...
<polymart-forex-heatmap category="major"></polymart-forex-heatmap>`} />
      ...
      <section className="mb-14">
        ...
        <p className="text-sm text-muted-foreground mb-6 max-w-xl">Forex widgets use a separate script. Add it alongside the stock widgets script.</p>
        <CodeBlock lang="HTML" code={`<script src="https://polymart.co/widgets/polymart-widgets.js" defer></script>\n<script src="https://polymart.co/widgets/polymart-forex-widgets.js" defer></script>`} />
