...
const _EVENTS_RAW = [
  ...
  // ── Macro black swans ──────────────────────────────────────────────────────
  {text:"BLACK MONDAY 2.0 - Algorithmic cascade triggers global selloff",  effect:-.22, weight:2, category:"macro"},
  {text:"MEGABANK COLLAPSE - $2T systemic shock, FDIC overwhelmed",        effect:-.28, weight:1, category:"macro"},
  {text:"SOVEREIGN DEFAULT CASCADE - 5 nations default simultaneously",    effect:-.25, weight:1, category:"macro"},
  {text:"EMERGENCY RATE HIKE - Fed raises 200bp in crisis session",        effect:-.20, weight:2, category:"macro"},
  {text:"EXCHANGE INFRASTRUCTURE FAILURE - NYSE dark for 4hrs globally",   effect:-.18, weight:2, category:"macro"},
  {text:"WAR DECLARATION - major powers, global markets in freefall",      effect:-.30, weight:1, category:"macro"},
  {text:"HISTORIC STIMULUS - $15T coordinated global central bank flood",  effect:.20,  weight:1, category:"macro"},
  {text:"PEACE DIVIDEND - landmark treaty, century-defining trade pact",   effect:.14,  weight:2, category:"macro"},
  {text:"HYPERINFLATION SIGNAL - CPI prints +4.2% single month",          effect:-.16, weight:2, category:"macro"},
  {text:"DEBT CEILING BREACH - US technical default, global panic",        effect:-.24, weight:1, category:"macro"},
  // ── Tech ───────────────────────────────────────────────────────────────────
  ...
  {text:"CRITICAL ZERO-DAY - internet backbone compromised, sector offline",   effect:-.24, weight:2, category:"event",    sector:"tech"},
  {text:"TECH MEGAMERGER - $900B consolidation reshapes entire sector",        effect:.18,  weight:2, category:"event",    sector:"tech"},
  {text:"MASS TECH LAYOFFS - 80,000 jobs cut in single week, confidence crush",effect:-.14, weight:2, category:"event",    sector:"tech"},
  // ── Food ───────────────────────────────────────────────────────────────────
  ...
  {text:"MEME NUKE - coordinated short attack, -80% sector wipeout",          effect:-.35, weight:2, category:"event",    sector:"meme"},
  {text:"MEME SUPERNOVA - viral moment drives 600% intraday spike",            effect:.35,  weight:2, category:"event",    sector:"meme"},
  {text:"SEC EMERGENCY HALT - all meme tickers suspended 24hrs",               effect:-.28, weight:2, category:"event",    sector:"meme"},
  // ── Green ──────────────────────────────────────────────────────────────────
  ...
  {text:"GLOBAL BANKING CRISIS - contagion across 14 major banks, runs begin", effect:-.32, weight:1, category:"event",    sector:"finance"},
  {text:"FLASH CRASH - HFT algo malfunction, 45-min -35% meltdown",           effect:-.22, weight:2, category:"event",    sector:"finance"},
  {text:"FOREX RESERVE CRISIS - dollar peg breaks, sector implodes",          effect:-.18, weight:2, category:"event",    sector:"finance"},
  // ── Gaming ─────────────────────────────────────────────────────────────────
  ...
  {text:"NATIONWIDE DRUG SCANDAL - 3 blockbusters pulled, sector collapses",  effect:-.22, weight:2, category:"event",    sector:"health"},
  {text:"CURE FOR ALL CANCERS - peer-reviewed, sector explodes on news",       effect:.26,  weight:1, category:"event",    sector:"health"},
  // ── Crypto ─────────────────────────────────────────────────────────────────
  ...
  {text:"CRYPTO WINTER - BTC crashes 75%, exchange bank runs begin",          effect:-.35, weight:2, category:"event",    sector:"crypto"},
  {text:"NATION-STATE ADOPTION - 3 countries declare BTC legal tender",       effect:.28,  weight:2, category:"event",    sector:"crypto"},
  {text:"REGULATORY WIPEOUT - 50-country coordinated ban, sector -60%",       effect:-.30, weight:1, category:"event",    sector:"crypto"},
  // ── Defence ────────────────────────────────────────────────────────────────
  ...
  {text:"SUPERINTELLIGENCE VERIFIED - self-improvement loop, sector explodes", effect:.32,  weight:1, category:"event",    sector:"ai"},
  {text:"AI WINTER 2.0 - 50-nation regulatory shutdown, all models offline",  effect:-.28, weight:1, category:"event",    sector:"ai"},
  {text:"AI CATASTROPHIC FAILURE - critical system kills 40 globally, probe", effect:-.22, weight:2, category:"event",    sector:"ai"},
  // ── Biotech ────────────────────────────────────────────────────────────────
  ...
  {text:"PANDEMIC DECLARATION - novel pathogen, 40-country emergency",        effect:-.26, weight:2, category:"event",    sector:"bio"},
  {text:"IMMORTALITY BREAKTHROUGH - aging reversal proven in humans",         effect:.30,  weight:1, category:"event",    sector:"bio"},
  {text:"MASS DRUG RECALL - contamination, 12M patients at risk, sector halt",effect:-.24, weight:2, category:"event",    sector:"bio"},
  // ── Auto ───────────────────────────────────────────────────────────────────
  ...
  {text:"GLOBAL TRAVEL SHUTDOWN - 80-country emergency ban, sector -50%",     effect:-.28, weight:1, category:"event",    sector:"travel"},
  {text:"MAJOR AIRLINE CRASH CLUSTER - 3 incidents in 48hrs, grounding",      effect:-.18, weight:2, category:"event",    sector:"travel"},
  // ── Energy ─────────────────────────────────────────────────────────────────
  ...
  {text:"GRID COLLAPSE - continental power outage, energy sector implodes",   effect:-.20, weight:2, category:"event",    sector:"energy"},
  {text:"ENERGY EMBARGO - major exporters cut all supplies, prices triple",   effect:.22,  weight:2, category:"event",    sector:"energy"},
  // ── Logistics ──────────────────────────────────────────────────────────────
