...
const EVENTS_RAW: Array<{text:string;effect:number;weight:number;sector?:string;category?:string}> = [
  ...
  {text:"Bull market rally continues — index hits ATH",effect:.03,weight:1,category:"macro"},
  ...
  {text:"G20 summit reaches historic fiscal accord",effect:.03,weight:1,category:"macro"},
  {text:"Central bank emergency rate cut — 75bp surprise",effect:.06,weight:3,category:"macro"},
  {text:"World Bank warns of stagflation risk",effect:-.04,weight:2,category:"macro"},
  {text:"Retail sales surge 1.8% MoM — demand robust",effect:.03,weight:1,category:"macro"},
  {text:"Housing starts collapse 22% — affordability crisis",effect:-.04,weight:2,category:"macro"},
  {text:"Yield curve steepens sharply — growth optimism",effect:.03,weight:1,category:"macro"},
  {text:"Margin debt at record high — leverage risk flagged",effect:-.03,weight:2,category:"macro"},
  {text:"M2 money supply contracts for 8th straight month",effect:-.03,weight:2,category:"macro"},
  {text:"Earnings season beats — 78% of companies top estimates",effect:.04,weight:2,category:"macro"},
  {text:"Earnings season misses — guidance slashed across sectors",effect:-.05,weight:2,category:"macro"},
  {text:"Global PMI expands to 54.2 — manufacturing boom",effect:.03,weight:1,category:"macro"},
  {text:"Services PMI contracts to 47.1 — sector slowdown",effect:-.03,weight:2,category:"macro"},
  {text:"Hedge funds cut net long exposure — risk off",effect:-.03,weight:1,category:"macro"},
  {text:"Institutional buyers absorb dip — record inflows",effect:.04,weight:2,category:"macro"},
  {text:"Currency crisis in emerging markets — contagion fears",effect:-.05,weight:2,category:"macro"},
  {text:"Commodity index hits 5yr high — supercycle signal",effect:.03,weight:1,category:"macro"},
  {text:"Black swan event — unexpected macro shock",effect:-.08,weight:3,category:"macro"},
  {text:"Surprise fiscal stimulus — $800B emergency package",effect:.06,weight:3,category:"macro"},
  // ── Tech ─────────────────────────────────────────────────────────────────────
  {text:"AI breakthrough — next-gen model surpasses human reasoning",effect:.08,sector:"tech",weight:3,category:"event"},
  ...
  {text:"Mega-merger — two tech giants combine in $400B deal",effect:.07,sector:"tech",weight:3,category:"event"},
  {text:"Cyber espionage campaign hits Fortune 500 firms",effect:-.05,sector:"tech",weight:2,category:"event"},
  {text:"Open-source AI model outperforms closed frontier models",effect:.05,sector:"tech",weight:2,category:"event"},
  {text:"Patent troll lawsuit — $18B in damages sought",effect:-.04,sector:"tech",weight:2,category:"event"},
  {text:"Tech layoffs — 40K jobs cut across sector",effect:-.04,sector:"tech",weight:2,category:"event"},
  {text:"Developer conference — groundbreaking platform APIs unveiled",effect:.05,sector:"tech",weight:2,category:"event"},
  {text:"Internet outage — BGP routing failure hits 60 countries",effect:-.06,sector:"tech",weight:2,category:"event"},
  {text:"New chip architecture — 3x performance per watt",effect:.06,sector:"tech",weight:2,category:"event"},
  {text:"SaaS revenue multiples expand — investor rotation into tech",effect:.05,sector:"tech",weight:2,category:"event"},
  {text:"Tech IPO boom — 5 unicorns list in single week",effect:.04,sector:"tech",weight:1,category:"event"},
  // ── Food ─────────────────────────────────────────────────────────────────────
  ...
  {text:"Global fast food chains post record quarterly sales",effect:.04,sector:"food",weight:1,category:"earnings"},
  {text:"Drought decimates coffee crop — prices +60%",effect:-.04,sector:"food",weight:2,category:"event"},
  {text:"Sugar tariff removed — margins improve sector-wide",effect:.03,sector:"food",weight:1,category:"macro"},
  {text:"AI nutrition app goes viral — 50M installs overnight",effect:.05,sector:"food",weight:2,category:"event"},
  {text:"Plant-based protein market doubles — survey data",effect:.04,sector:"food",weight:1,category:"event"},
  {text:"Listeria contamination — major brand voluntary recall",effect:-.05,sector:"food",weight:2,category:"event"},
  {text:"Packaging cost crash — commodity input relief",effect:.03,sector:"food",weight:1,category:"event"},
  // ── Space ────────────────────────────────────────────────────────────────────
  ...
  {text:"Space tourism breaks 10K passenger milestone",effect:.05,sector:"space",weight:1,category:"event"},
  {text:"Asteroid mining licence granted — rare earth access",effect:.07,sector:"space",weight:2,category:"event"},
  {text:"Rocket reusability record — 30 flights on single booster",effect:.04,sector:"space",weight:1,category:"event"},
  {text:"Space debris regulation enacted — additional costs",effect:-.04,sector:"space",weight:2,category:"macro"},
  {text:"ISS successor contract — $90B 20yr programme signed",effect:.08,sector:"space",weight:3,category:"event"},
  // ── Meme ─────────────────────────────────────────────────────────────────────
  ...
  {text:"QUAK goes viral — duck meme floods social media",effect:.18,sector:"meme",weight:3,category:"event"},
  {text:"Celebrity tweets 'QUAK to the moon' — volume spikes",effect:.14,sector:"meme",weight:3,category:"event"},
  {text:"SEC opens meme stock manipulation investigation",effect:-.08,sector:"meme",weight:2,category:"event"},
  {text:"Reddit board coordinates moonshot — meme rally day",effect:.13,sector:"meme",weight:3,category:"event"},
  {text:"Meme sector flash dump — whale exits position",effect:-.11,sector:"meme",weight:3,category:"event"},
  {text:"Discord leak reveals coordinated pump scheme",effect:-.07,sector:"meme",weight:2,category:"event"},
  {text:"Meme stocks trending globally — media coverage peaks",effect:.10,sector:"meme",weight:2,category:"event"},
  // ── Green ────────────────────────────────────────────────────────────────────
  ...
  {text:"EU carbon border tax takes effect — green premium",effect:.05,sector:"green",weight:2,category:"macro"},
  {text:"Wind farm decommissioning costs spiral — write-downs",effect:-.04,sector:"green",weight:2,category:"event"},
  {text:"Green hydrogen cost reaches grid parity",effect:.07,sector:"green",weight:2,category:"event"},
  {text:"Lithium price crash — supply glut from Chile",effect:-.04,sector:"green",weight:2,category:"event"},
  {text:"Net-zero pledge — 50 nations sign binding accord",effect:.05,sector:"green",weight:2,category:"macro"},
  {text:"Green bond market hits $2T — record issuance",effect:.04,sector:"green",weight:1,category:"event"},
  // ── Finance ──────────────────────────────────────────────────────────────────
  ...
  {text:"New Basel capital rules — tier-1 ratios tighten",effect:-.04,sector:"finance",weight:2,category:"macro"},
  {text:"IPO pipeline surges — 30 filings in single week",effect:.04,sector:"finance",weight:1,category:"event"},
  {text:"Insider trading ring busted — $2B in ill-gotten gains",effect:-.05,sector:"finance",weight:2,category:"event"},
  {text:"M&A advisory fees hit record — deal volume surges",effect:.05,sector:"finance",weight:2,category:"earnings"},
  {text:"Credit card delinquencies at 15yr high",effect:-.05,sector:"finance",weight:2,category:"event"},
  {text:"BNPL regulation tightens — sector margin squeeze",effect:-.04,sector:"finance",weight:2,category:"macro"},
  {text:"Sovereign wealth fund pumps $150B into equities",effect:.05,sector:"finance",weight:2,category:"event"},
  // ── Gaming ───────────────────────────────────────────────────────────────────
  ...
  {text:"Metaverse gaming hits 500M daily active users",effect:.08,sector:"gaming",weight:2,category:"event"},
  {text:"Loot box ban expands to 20 countries",effect:-.05,sector:"gaming",weight:2,category:"macro"},
  {text:"Mobile gaming revenue surpasses console for first time",effect:.05,sector:"gaming",weight:2,category:"event"},
  {text:"Major studio acquisition — $18B deal reshapes sector",effect:.07,sector:"gaming",weight:2,category:"event"},
  {text:"In-game currency scam — 8M accounts compromised",effect:-.05,sector:"gaming",weight:2,category:"event"},
  {text:"AI-generated game worlds launch — infinite content",effect:.06,sector:"gaming",weight:2,category:"event"},
  // ── Health ───────────────────────────────────────────────────────────────────
  ...
  {text:"Obesity drug sales triple — blockbuster status",effect:.08,sector:"health",weight:2,category:"earnings"},
  {text:"Hospital supply chain crisis — elective surgery backlog",effect:-.05,sector:"health",weight:2,category:"event"},
  {text:"Telehealth reimbursement expanded — CMS ruling",effect:.05,sector:"health",weight:2,category:"macro"},
  {text:"Pandemic preparedness act — $300B biodefence fund",effect:.06,sector:"health",weight:2,category:"macro"},
  {text:"Generic drug shortage — 40 key medicines affected",effect:-.04,sector:"health",weight:2,category:"event"},
  {text:"AI diagnostics outperform radiologists — landmark study",effect:.06,sector:"health",weight:2,category:"event"},
  // ── Crypto ───────────────────────────────────────────────────────────────────
  ...
  {text:"DeFi protocol drained — $600M flash loan exploit",effect:-.10,sector:"crypto",weight:3,category:"event"},
  {text:"Nation state adopts Bitcoin as legal tender",effect:.11,sector:"crypto",weight:3,category:"event"},
  {text:"Crypto mining ban in three major economies",effect:-.07,sector:"crypto",weight:2,category:"macro"},
  {text:"Layer-2 adoption surges — gas fees hit near zero",effect:.07,sector:"crypto",weight:2,category:"event"},
  {text:"Whale accumulation detected — $4B in BTC inflows",effect:.08,sector:"crypto",weight:2,category:"event"},
  {text:"Regulatory clarity bill passes — crypto finally legal",effect:.10,sector:"crypto",weight:3,category:"macro"},
  // ── Defence ──────────────────────────────────────────────────────────────────
  ...
  {text:"NATO allies commit 3% GDP to defence spending",effect:.07,sector:"defence",weight:3,category:"macro"},
  {text:"Directed energy weapon deployed operationally",effect:.06,sector:"defence",weight:2,category:"event"},
  {text:"Cyber warfare unit established — $20B investment",effect:.05,sector:"defence",weight:2,category:"event"},
  {text:"Peace dividend — defence budget cut 8%",effect:-.06,sector:"defence",weight:2,category:"macro"},
  {text:"Space-based missile defence system approved",effect:.07,sector:"defence",weight:2,category:"event"},
  // ── Retail ───────────────────────────────────────────────────────────────────
  ...
  {text:"Same-day delivery mandated — logistics costs surge",effect:-.04,sector:"retail",weight:2,category:"event"},
  {text:"Brand boycott goes viral — 15% sales drop projected",effect:-.06,sector:"retail",weight:2,category:"event"},
  {text:"AI personal shopper — 40% conversion uplift",effect:.05,sector:"retail",weight:2,category:"event"},
  {text:"Return rate crisis — free returns policy unsustainable",effect:-.04,sector:"retail",weight:2,category:"event"},
  {text:"Flash sale breaks platform records — $8B in 24hrs",effect:.05,sector:"retail",weight:2,category:"earnings"},
  {text:"Resale market surges — pre-owned goods mainstream",effect:.04,sector:"retail",weight:1,category:"event"},
  // ── Media ────────────────────────────────────────────────────────────────────
  ...
  {text:"Podcast advertising surpasses radio for first time",effect:.05,sector:"media",weight:1,category:"event"},
  {text:"Deepfake content crisis — platform liability bill",effect:-.05,sector:"media",weight:2,category:"macro"},
  {text:"Live sports rights auction — $60B 10yr deal",effect:.07,sector:"media",weight:2,category:"event"},
  {text:"Ad-free tier adoption peaks — subscription fatigue",effect:-.04,sector:"media",weight:2,category:"event"},
  {text:"AI-generated content floods platforms — quality debate",effect:-.04,sector:"media",weight:2,category:"event"},
  {text:"Viral creator signs exclusive $500M platform deal",effect:.05,sector:"media",weight:2,category:"event"},
  // ── AI ───────────────────────────────────────────────────────────────────────
  ...
  {text:"AI replaces 20% of white-collar jobs — productivity spike",effect:.08,sector:"ai",weight:3,category:"event"},
  {text:"Model collapse event — training data contaminated",effect:-.07,sector:"ai",weight:2,category:"event"},
  {text:"Autonomous AI agent completes 30-day unsupervised task",effect:.09,sector:"ai",weight:3,category:"event"},
  {text:"AI chip shortage — NVIDIA lead times hit 52 weeks",effect:-.06,sector:"ai",weight:2,category:"event"},
  {text:"Open-weight frontier model — free release disrupts market",effect:-.05,sector:"ai",weight:2,category:"event"},
  {text:"AI-designed drug enters clinical trial in record 18mo",effect:.07,sector:"ai",weight:2,category:"event"},
  {text:"Enterprise AI spending hits $1T annual run rate",effect:.08,sector:"ai",weight:2,category:"event"},
  // ── Biotech ──────────────────────────────────────────────────────────────────
  ...
  {text:"Synthetic biology platform — custom proteins on demand",effect:.08,sector:"bio",weight:2,category:"event"},
  {text:"FDA rejects BLA — manufacturing deficiencies cited",effect:-.08,sector:"bio",weight:2,category:"event"},
  {text:"mRNA platform expanded — 12 new pipeline candidates",effect:.07,sector:"bio",weight:2,category:"event"},
  {text:"Bioreactor breakthrough — 10x cell culture yield",effect:.06,sector:"bio",weight:2,category:"event"},
  {text:"Orphan drug designation — fast-track exclusivity granted",effect:.07,sector:"bio",weight:2,category:"event"},
  {text:"Gene sequencing cost drops to $50 — mass market era",effect:.06,sector:"bio",weight:2,category:"event"},
  // ── Auto ─────────────────────────────────────────────────────────────────────
  ...
  {text:"Flying car type-certified — urban air taxi approved",effect:.08,sector:"auto",weight:2,category:"event"},
  {text:"ICE ban confirmed 2035 — EV transition accelerates",effect:.06,sector:"auto",weight:2,category:"macro"},
  {text:"Robotaxi rollout — 10 cities licence full autonomy",effect:.07,sector:"auto",weight:2,category:"event"},
  {text:"Auto union strike — 60-day production halt",effect:-.07,sector:"auto",weight:2,category:"event"},
  {text:"Solid-state EV battery — 1,000-mile range proven",effect:.09,sector:"auto",weight:3,category:"event"},
  // ── Real Estate ──────────────────────────────────────────────────────────────
  ...
  {text:"Office vacancy hits 35% — remote work permanent",effect:-.07,sector:"realty",weight:2,category:"event"},
  {text:"Build-to-rent sector explodes — $400B new builds",effect:.06,sector:"realty",weight:2,category:"event"},
  {text:"Zoning reform unlocks dense urban development",effect:.05,sector:"realty",weight:2,category:"macro"},
  {text:"PropTech AI valuation tool disrupts appraisal industry",effect:.04,sector:"realty",weight:1,category:"event"},
  {text:"REIT dividend cuts — cash flow under pressure",effect:-.05,sector:"realty",weight:2,category:"earnings"},
  {text:"Institutional landlord regulation — rent cap bill",effect:-.05,sector:"realty",weight:2,category:"macro"},
  // ── Travel ───────────────────────────────────────────────────────────────────
  ...
  {text:"Luxury cruise bookings hit all-time record",effect:.06,sector:"travel",weight:2,category:"earnings"},
  {text:"Airport capacity crunch — summer chaos, cancellations",effect:-.05,sector:"travel",weight:2,category:"event"},
  {text:"Visa-free zone expands — 40 nations open borders",effect:.05,sector:"travel",weight:2,category:"macro"},
  {text:"Pilot shortage hits critical — 8,000 vacancies unfilled",effect:-.05,sector:"travel",weight:2,category:"event"},
  {text:"Digital nomad visa boom — long-stay travel surges",effect:.04,sector:"travel",weight:1,category:"event"},
  {text:"Airline carbon offset mandate — operating costs rise",effect:-.04,sector:"travel",weight:2,category:"macro"},
  // ── Energy ───────────────────────────────────────────────────────────────────
  ...
  {text:"Natural gas pipeline sabotage — European supply cut",effect:-.06,sector:"energy",weight:2,category:"event"},
  {text:"LNG terminal opens — US exports surge 40%",effect:.05,sector:"energy",weight:2,category:"event"},
  {text:"Nuclear renaissance — 20 new reactors approved",effect:.07,sector:"energy",weight:2,category:"event"},
  {text:"Energy grid cyberattack — 10M homes without power",effect:-.08,sector:"energy",weight:3,category:"event"},
  {text:"Oil demand peak confirmed — IEA revises forecast",effect:-.05,sector:"energy",weight:2,category:"macro"},
  // ── Logistics ────────────────────────────────────────────────────────────────
  ...
  {text:"Autonomous trucking approved — 48-state network live",effect:.08,sector:"logistics",weight:3,category:"event"},
  {text:"Freight rates collapse 50% — overcapacity glut",effect:-.05,sector:"logistics",weight:2,category:"event"},
  {text:"Hyperloop freight corridor opens — coast-to-coast 3hrs",effect:.07,sector:"logistics",weight:2,category:"event"},
  {text:"Cold chain IoT mandate — compliance costs spike",effect:-.04,sector:"logistics",weight:2,category:"macro"},
  {text:"Last-mile robotics deployment — 100 cities rollout",effect:.06,sector:"logistics",weight:2,category:"event"},
  {text:"Suez Canal blockage — $10B/day trade disruption",effect:-.07,sector:"logistics",weight:2,category:"event"},
  // ── Agriculture ──────────────────────────────────────────────────────────────
  ...
  {text:"Locust plague devastates East African harvest",effect:-.07,sector:"agri",weight:2,category:"event"},
  {text:"Soil microbiome breakthrough — yields up 18%",effect:.06,sector:"agri",weight:2,category:"event"},
  {text:"Precision agriculture AI — input waste cut 40%",effect:.05,sector:"agri",weight:1,category:"event"},
  {text:"Water rights crisis — irrigation cuts mandated",effect:-.06,sector:"agri",weight:2,category:"macro"},
  {text:"Record harvest — global grain stockpiles at 20yr high",effect:.05,sector:"agri",weight:2,category:"event"},
  {text:"Carbon farming credits — farmers paid to sequester CO2",effect:.04,sector:"agri",weight:1,category:"macro"},
  {text:"Agri-drone spraying legalised — 80 country rollout",effect:.05,sector:"agri",weight:2,category:"event"},
];
